...
//Better button
better_text_width = string_width("We must be better");
better_text_height = string_height("We must be better");

draw_set_alpha(better_text_small_alpha);
draw_text_transformed(room_width/2, room_height/2 + BETTER_TXT_DISPL, string("We must be better"), 0.6, 0.6, 0);

draw_set_alpha(better_text_large_alpha);
draw_text_transformed(room_width/2, room_height/2 + BETTER_TXT_DISPL, string("We must be better"), 0.8, 0.8, 0);
